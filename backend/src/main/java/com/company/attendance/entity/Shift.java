 ...
 *
 * Defines working hours, grace periods, and timezone information for calculating
...
public class Shift {
	...
	public boolean isWithinEntryWindow(LocalTime time) {
		...
		LocalTime entryEnd = startTime.plusMinutes(gracePeriodMinutes * 2); // Extended
																			// window for
																			// entry
	...
	public boolean isWithinExitWindow(LocalTime time) {
		LocalTime exitStart = endTime.minusMinutes(gracePeriodMinutes * 2); // Extended
																			// window for
																			// early exit
