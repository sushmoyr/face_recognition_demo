 ...
 *
 * Generated from recognition events and contains calculated attendance information
 * including late arrivals, early departures, and duration.
 */
@Entity
...
public class AttendanceRecord {
	...
	public boolean hasComplianceIssues() {
		return Boolean.TRUE.equals(isLate) || Boolean.TRUE.equals(isEarlyLeave) || !status.isCompliant();
	}
