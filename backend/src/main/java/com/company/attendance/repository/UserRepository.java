 ...
 *
 * Manages user authentication, authorization, and user account administration.
 */
@Repository
public interface UserRepository extends JpaRepository<User, UUID> {
	 ...
	 */
	@Query("SELECT u FROM User u WHERE " + "u.lastLoginAt < :cutoffTime OR u.lastLoginAt IS NULL")
