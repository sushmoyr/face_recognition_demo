 ...
 *
 * Defines time windows, grace periods, cooldowns, and other business rules for attendance
 * processing on a per-shift basis.
 */
@Entity
...
public class AttendancePolicy {
	...
	private Integer earlyArrivalGraceMinutes = 15; // Don't mark as early if within 15 min
													// of shift start

	@Column(name = "late_arrival_grace_minutes", nullable = false)
	private Integer lateArrivalGraceMinutes = 10; // Don't mark as late if within 10 min
													// after shift start

	@Column(name = "early_departure_grace_minutes", nullable = false)
	private Integer earlyDepartureGraceMinutes = 15; // Don't mark as early departure if
														// within 15 min of shift end

	@Column(name = "overtime_threshold_minutes", nullable = false)
	private Integer overtimeThresholdMinutes = 30; // Start counting overtime after 30 min
													// past shift end
