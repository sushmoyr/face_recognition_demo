 ...
 *
 * Provides CRUD operations and custom queries for employee management including search,
 * filtering, and face template related queries.
 */
@Repository
public interface EmployeeRepository extends JpaRepository<Employee, UUID>, JpaSpecificationExecutor<Employee> {
	 ...
	 */
	@Query("SELECT DISTINCT e FROM Employee e " + "LEFT JOIN FETCH e.faceTemplates ft " + "WHERE ft.isActive = true")
