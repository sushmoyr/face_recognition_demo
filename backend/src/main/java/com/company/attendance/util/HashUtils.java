 ...
 *
 * Provides deduplication capabilities by creating unique fingerprints from recognition
 * event data including image content, employee, device, and timing.
 */
@Component
@Slf4j
public class HashUtils {
	 ...
	 *
	 * The hash is based on: - Image file content (if available) - Employee code - Device
	 * ID - Time window (5-minute buckets for near-duplicate detection)
