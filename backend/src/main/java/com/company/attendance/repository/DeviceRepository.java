 ...
 *
 * Manages camera and edge device records including connectivity status and location-based
 * queries.
 */
@Repository
public interface DeviceRepository extends JpaRepository<Device, UUID> {
	 ...
	 */
	@Query("SELECT d FROM Device d WHERE " + "(d.lastSeenAt IS NULL OR d.lastSeenAt <= :cutoffTime) "
			+ "AND d.status = 'ACTIVE'")
