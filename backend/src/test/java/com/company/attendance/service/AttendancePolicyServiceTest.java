 ...
 * 
 * Tests complex attendance business rules including:
 * - Time window validation
 * - Grace period calculations
 * - Cooldown period enforcement
 * - Timezone handling for Asia/Dhaka
...
class AttendancePolicyServiceTest {
    ...
    class GracePeriodTests {
        ...
        void shouldMarkOnTimeWithinGracePeriod() {
            // Given: Clock-in at 9:08 AM (8 minutes after shift start, within 10 min grace)
        ...
        void shouldMarkLateOutsideGracePeriod() {
            // Given: Clock-in at 9:15 AM (15 minutes after shift start, outside 10 min grace)
        ...
        void shouldMarkEarlyArrival() {
            // Given: Clock-in at 8:30 AM (30 minutes before shift start, outside 15 min grace)
    ...
    class OvertimeComplianceTests {
        ...
        void shouldCalculateOvertimeCorrectly() {
            ...
            assertThat(evaluation.getCompliance().getOvertimeMinutes()).isEqualTo(30);  // 60 min - 30 min threshold
        }

        @Test
        @DisplayName("Should detect early departure correctly")
        void shouldDetectEarlyDeparture() {
            // Given: Clock-out at 4:30 PM (30 minutes before shift end, outside 15 min grace)
