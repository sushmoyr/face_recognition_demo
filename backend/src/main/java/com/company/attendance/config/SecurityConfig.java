 ...
 *
 * Configures security filters, CORS, authentication providers, and role-based access
	...
	public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationProvider authenticationProvider, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
		http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
			...
			.authorizeHttpRequests(authz -> authz
				...
				.requestMatchers(HttpMethod.POST, "/api/employees/*/faces")
				.hasAnyRole("ADMIN", "HR")
				.requestMatchers("/api/attendance/**")
				.hasAnyRole("ADMIN", "HR", "VIEWER")

				// Edge node endpoints
				.requestMatchers(HttpMethod.POST, "/api/recognitions")
				.hasAnyRole("ADMIN", "EDGE_NODE")
				.requestMatchers(HttpMethod.GET, "/api/employees/templates")
				.hasAnyRole("ADMIN", "EDGE_NODE")
				.requestMatchers(HttpMethod.POST, "/api/devices/heartbeat")
				.hasAnyRole("ADMIN", "EDGE_NODE")
