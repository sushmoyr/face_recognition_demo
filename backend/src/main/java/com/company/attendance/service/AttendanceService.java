 ...
 * 
 * Handles IN/OUT detection, late arrival/early departure calculation,
 * shift compliance, and cooldown periods.
 */
@Service
...
public class AttendanceService {
    ...
    public Optional<AttendanceRecord> processRecognitionEvent(RecognitionEvent recognitionEvent) {
        ...
        log.info("Created attendance record: Employee {} - {} at {} ({})", 
                employee.getEmployeeCode(), eventType, eventTime, 
                attendanceRecord.hasComplianceIssues() ? "NON-COMPLIANT" : "COMPLIANT");
